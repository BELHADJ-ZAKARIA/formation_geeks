...
('5XXGM4A74DG116120','Dacia','Duster',2025,2200000.00,'Grey','https://journalauto.com/wp-content/uploads/2023/11/1-Dacia-Duster-Journey-Guincho.jpg');
...
(1, 1, 3, '2023-10-05', (SELECT price FROM vehicles WHERE id = vehicle_id)),
(3, 2, 1, '2023-10-12', 440000.00),
(5, 1, 2, '2023-10-15', 238000.00),
(2, 3, 5, '2023-10-20', 215000.00),
(7, 4, 4, '2023-11-01', 255000.00),
(8, 5, 7, '2023-11-05', 285000.00),
(10, 2, 6, '2023-11-10', 275000.00),
(12, 4, 8, '2023-11-12', 640000.00);

ALTER TABLE salespeople
ADD COLUMN Total_Sales_Value DECIMAL(10, 2);