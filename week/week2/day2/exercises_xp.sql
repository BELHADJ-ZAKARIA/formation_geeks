...
*/
SELECT film_id, title, description, length, rental_rate FROM film WHERE title like 'Into the wild';
...
id, names (first and last), the amount and the date of payment ordered 
